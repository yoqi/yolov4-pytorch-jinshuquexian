...
class YOLO(object):
    _defaults = {
        "model_path"        : 'logs/Epoch40-Total_Loss5.2452-Val_Loss7.1612.pth',
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='model_data/simhei.ttf',size=2*np.floor(3e-2 * np.shape(image)[1] + 0.5).astype('int32'))
